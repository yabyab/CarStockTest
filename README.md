...
| POST           | /api/Stock/AdjQty    | application/json | {<br>&emsp;**"stockid"** integer($int32)<br>&emsp;&emsp;nullable: false,<br>&emsp;&emsp;range: 0 < stockid,<br>&emsp;**"quantity"** integer($int32)<br>&emsp;&emsp;nullable: false,<br>&emsp;&emsp;range: 0 <= price <= 9999999<br>} |{<br>&emsp;"stockid": 16,<br>&emsp;"quantity": 3<br>} |
